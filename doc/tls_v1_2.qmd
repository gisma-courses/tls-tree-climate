...
<iframe width="100%" height="600" src="tree:voxel_viewer.html" frameborder="0"> </iframe>
...
```
::: {.callout-tip title="Interactive Pipe" appearance="minimal" collapse="true"}
